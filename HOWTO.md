...
Si se encuentra dentro de <b>GCP</b>, primero va a crear un proyecto en la consola de GCP, para obtener el ID del mismo. Esto va a ser requerido para luego utilizarlo en la definición de proovedor. 
